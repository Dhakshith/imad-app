...
<html>
    ...
    <body><div class="container">
            ...
            <div class = "Footer">
                <h1>
                    This button <button id="counter" style="background-color: brown;padding: 15px 32px;"><p style="color: white">Click Me !</button> has been clicked <span id="count">0</span> times...
                </h1>    
            </div>
            <hr/>
            ...
            <div style="color: #FF8000;font-size: 30px"><ul>
                <li>
                    name1
                </li>
                <li>
