...
<html>
    ...
    <body><div class="container">
            ...
            <div class = "Footer">
                <h1>
                    This button <button id="counter" style="background-color: brown;padding: 15px 32px;"><p style="color: white;font-size: 13px">Click Me !</button> has been clicked <span id="count">0</span> times...
                </h1>    
            </div>
            <hr/>
