...
profile = {
    ...
    <body><div class="container">
            ...
            <div class = "Footer">
                <h1>
                    This button <button id="counter" style="background-color: brown;padding: 15px 32px;"><p style="color: white;font-size: 17.5px">Click Me !</button> has been clicked <span id="count"><p style="font-size:50px;color:black">0</p></span> times ! ! !
                </h1>    
            </div>
            <hr/>
